...
def resumen_base(consulta: str) -> str:
    ...
    Usa esta herramienta para preguntas generales sobre la base.
    """
...
def contar_internaciones_activas(consulta: str) -> str:
    ...
    Una internación activa es aquella que no tiene fecha de egreso.
    """
...
def historial_por_chist(consulta: str) -> str:
    ...
    Usa esta herramienta cuando la pregunta mencione un CHIST.
    """
    _, _, movimientos = cargar_datos()
...
def crear_agente():
    ...
    - Usa las herramientas disponibles para consultar el dataset.
    - No inventes cifras.
    - Si la pregunta pide cantidades, rankings, diagnósticos, pabellones, movimientos o historiales, usa una herramienta.
